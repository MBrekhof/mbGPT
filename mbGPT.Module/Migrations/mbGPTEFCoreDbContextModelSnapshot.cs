...
{
    [DbContext(typeof(mbGPTEFCoreDbContext))]
    partial class mbGPTEFCoreDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("mbGPT.Module.BusinessObjects.ApplicationUserLoginInfo", b =>
                {
                    b.Property<Guid>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("mbGPT.Module.BusinessObjects.Article", b =>
                {
            ...
            modelBuilder.Entity("mbGPT.Module.BusinessObjects.ArticleDetail", b =>
                {
            ...
            modelBuilder.Entity("mbGPT.Module.BusinessObjects.Base.FileSystemStoreObjectBase", b =>
                {
                    b.Property<Guid>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("mbGPT.Module.BusinessObjects.Chat", b =>
                {
            ...
            modelBuilder.Entity("mbGPT.Module.BusinessObjects.ChatModel", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("mbGPT.Module.BusinessObjects.CodeObject", b =>
                {
            ...
            modelBuilder.Entity("mbGPT.Module.BusinessObjects.CodeObjectCategory", b =>
                {
                    b.Property<int>("CodeObjectCategoryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("mbGPT.Module.BusinessObjects.Cost", b =>
                {
                    ...
                    b.HasIndex("ArticleId")
                        .HasDatabaseName("ix_cost_articleid");
            ...
            modelBuilder.Entity("mbGPT.Module.BusinessObjects.EmbeddingModel", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("mbGPT.Module.BusinessObjects.FileSystemStoreObject", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("mbGPT.Module.BusinessObjects.MailData", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("mbGPT.Module.BusinessObjects.Prompt", b =>
                {
                    b.Property<int>("PromptID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("mbGPT.Module.BusinessObjects.Settings", b =>
                {
            ...
            modelBuilder.Entity("mbGPT.Module.BusinessObjects.SimilarContentArticlesResult", b =>
                {
                    b.Property<long>("id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("mbGPT.Module.BusinessObjects.Tag", b =>
                {
            ...
            modelBuilder.Entity("mbGPT.Module.BusinessObjects.UsedKnowledge", b =>
                {
            ...
            modelBuilder.Entity("mbGPT.Module.BusinessObjects.WebSiteData", b =>
                {
            ...
            modelBuilder.Entity("mbGPT.Module.BusinessObjects.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("CodeObjectTag", b =>
                {
                    b.HasOne("mbGPT.Module.BusinessObjects.CodeObject", null)
                        .WithMany()
                    ...
                    b.HasOne("mbGPT.Module.BusinessObjects.Tag", null)
                        .WithMany()
            ...
            modelBuilder.Entity("mbGPT.Module.BusinessObjects.ApplicationUserLoginInfo", b =>
                {
                    b.HasOne("mbGPT.Module.BusinessObjects.ApplicationUser", "User")
                        .WithMany("UserLogins")
            ...
            modelBuilder.Entity("mbGPT.Module.BusinessObjects.ArticleDetail", b =>
                {
                    b.HasOne("mbGPT.Module.BusinessObjects.Article", "Article")
            ...
            modelBuilder.Entity("mbGPT.Module.BusinessObjects.Chat", b =>
                {
                    b.HasOne("mbGPT.Module.BusinessObjects.ChatModel", "ChatModel")
                        .WithMany()
                        .HasForeignKey("ChatModelID")
                        .HasConstraintName("fk_chat_chatmodel_chatmodelid");

                    b.HasOne("mbGPT.Module.BusinessObjects.Prompt", "Prompt")
                        .WithMany()
            ...
            modelBuilder.Entity("mbGPT.Module.BusinessObjects.CodeObject", b =>
                {
                    b.HasOne("mbGPT.Module.BusinessObjects.CodeObjectCategory", "Category")
                        .WithMany()
            ...
            modelBuilder.Entity("mbGPT.Module.BusinessObjects.Cost", b =>
                {
                    b.HasOne("mbGPT.Module.BusinessObjects.ArticleDetail", "ArticleDetail")
                        .WithMany()
                    ...
                    b.HasOne("mbGPT.Module.BusinessObjects.Article", "Article")
                        .WithMany()
                        .HasForeignKey("ArticleId")
                        .HasConstraintName("fk_cost_article_articleid");

                    b.HasOne("mbGPT.Module.BusinessObjects.Chat", "Chat")
                        .WithMany()
                        .HasForeignKey("ChatId")
                        .HasConstraintName("fk_cost_chat_chatid");

                    b.HasOne("mbGPT.Module.BusinessObjects.CodeObject", "CodeObject")
                        .WithMany()
            ...
            modelBuilder.Entity("mbGPT.Module.BusinessObjects.FileSystemStoreObject", b =>
                {
                    b.HasOne("mbGPT.Module.BusinessObjects.Base.FileSystemStoreObjectBase", "File")
                        .WithMany()
            ...
            modelBuilder.Entity("mbGPT.Module.BusinessObjects.Settings", b =>
                {
                    ...
                    b.HasOne("mbGPT.Module.BusinessObjects.EmbeddingModel", "EmbeddingModel")
                        .WithMany()
            ...
            modelBuilder.Entity("mbGPT.Module.BusinessObjects.UsedKnowledge", b =>
                {
                    b.HasOne("mbGPT.Module.BusinessObjects.ArticleDetail", "Article")
                        .WithMany()
                        .HasForeignKey("ArticleDetailId")
                    ...
                    b.HasOne("mbGPT.Module.BusinessObjects.CodeObject", "Code")
                        .WithMany()
                        .HasForeignKey("CodeObjectId")
